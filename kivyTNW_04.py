...
stA = {"station": "Blaesiring"}
stB = {"station": "Erasmusplatz"}
stC = {"station": "Johanniterbruecke"}
stD = {"station": "Freilager"}
urlStation = "http://transport.opendata.ch/v1/stationboard"
...
class queryTNW(GridLayout, Screen):
    ...
    def req(*args):
        r = requests.get(urlStation, params=args[1])
        jData = r.json()
